...
export const portableFiles = Object.freeze([
  ...
  ...['career.mjs','core.mjs','decoder.mjs','gear-data.json','hunting-pressure.mjs','maps-data.json','observer.mjs','phone-access.mjs','phone-registration.mjs','phone-bridge.mjs','phone-service.json','rating-data.json','reference.json','stat-definitions.json','store.mjs','route-planner.mjs','route-setup.mjs'].map(name => `lib/${name}`),
