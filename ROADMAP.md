# Product scope and release frontier

## Available in the 0.4 preview source
...
Lifetime kills, individual shot/health identity, arbitrary reserve attribution of global totals, complete historical receipt coverage, exact Great One spawn odds, verified rarity from an untranslated ID, and publisher approval. Unharvested state is not lifetime kills. The local observer does not automate shooting or harvest actions.

## Next product milestones

1. Expand fixture coverage and compare saved counters against the in-game career screen across additional accounts/patches. Preserve disagreements, do not force numerical reconciliation.
...
## Public publication is not private-data publication

The source-to-web build has an explicit allowlist. Do not add real game saves, databases, account paths, user screenshots or screenshots of native career totals to public commits. Use clearly labeled synthetic examples for public demonstrations.
