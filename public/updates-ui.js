...
class Updates extends HTMLElement{
 ...
 async refresh(check=false){if(this.pending)return;this.pending=true;const ticket=++this.generation;this.request=new AbortController();if(check)this.render();
