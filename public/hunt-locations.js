...
export function huntLocationsView(state,{sessionId=null}={}){
  ...
  if(sessionId){
   ...
   if(!session||session.endedAt!=null||session.pausedAt!=null)return '<section class="gz-locations" aria-label="Hunt locations"><h2>Where it happened</h2><p>Resume this grind to see locations from its tracking periods. Your journal is preserved.</p></section>';
  }
