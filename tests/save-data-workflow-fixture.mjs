...
import {writeDiscoveryFixture} from './zone-discovery-fixture.mjs';
...
export function writeSaveDataFixture(save){
  writeDiscoveryFixture(save);
  writeProfile(save);
  writeFileSync(path.join(save,'playerinformation_adf'),fixture(workflowDefs,'player',{NumUnharvestedAnimals:2,AnimalHarvestStreak:9,TimeOfDay:12}));
