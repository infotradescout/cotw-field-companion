...
const session=v=>({...fields(v,'id reserve name startedAt endedAt'),harvestSummary:v.harvestSummary?{...fields(v.harvestSummary,'total scope timeBasis reserveScope'),bySpecies:rows(v.harvestSummary.bySpecies,r=>fields(r,'species count'),2000)}:null});
