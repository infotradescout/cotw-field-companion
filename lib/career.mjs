...
export function careerCounters(snapshot){
 ...
 return dictionary.definitions.filter(d=>d.type!==2).map(d=>({key:d.key,label:d.label||pretty(d.labelKey||d.key),value:get(d.id),display:d.display,computed:d.type===3,visible:d.visible,sourceId:d.id}));
}
